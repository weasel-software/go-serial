...
The canonical import for this library is github.com/weasel-software/go-serial so the import line
is the following:
...
GetDetailedPortsList function in the enumerator package:
	...
	import "github.com/weasel-software/go-serial/enumerator"
